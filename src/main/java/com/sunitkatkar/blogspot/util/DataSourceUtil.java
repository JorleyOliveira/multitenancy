...
//        ds.setDriverClassName("com.mysql.jdbc.Driver");
    ...
    public static DataSource createAndConfigureDataSource(
    	...
    	defaultDataSource.setUrl(masterTenant.getUrl());
    	defaultDataSource.setUser(masterTenant.getUsername());
    	defaultDataSource.setPassword(masterTenant.getPassword());    	
    	defaultDataSource.setCurrentSchema(masterTenant.getTenantId());
    	defaultDataSource.setConnectTimeout(20000);
    	LOG.info("Configured datasource:" + masterTenant.getTenantId()
        + ". Connection poolname:" + masterTenant.getTenantId());
