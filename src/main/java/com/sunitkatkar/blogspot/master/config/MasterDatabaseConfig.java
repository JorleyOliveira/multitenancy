...
public class MasterDatabaseConfig {
    ...
    public DataSource masterDataSource() {
        ...
        LOG.info("Setting up masterDataSource with: "
                + masterDbProperties.toString());
	    PGSimpleDataSource defaultDataSource = new PGSimpleDataSource();
		defaultDataSource.setUrl(masterDbProperties.getUrl());
		defaultDataSource.setUser(masterDbProperties.getUsername());
		defaultDataSource.setPassword(masterDbProperties.getPassword());    	
		defaultDataSource.setCurrentSchema("public");
		defaultDataSource.setConnectTimeout(20000);		
	    LOG.info("Setup of masterDataSource succeeded.");
