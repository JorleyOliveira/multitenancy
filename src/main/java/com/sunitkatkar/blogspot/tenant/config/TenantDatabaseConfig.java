...
@ComponentScan(basePackages = { "com.sunitkatkar.blogspot.tenant.repository", "com.sunitkatkar.blogspot.tenant.model" })
@EnableJpaRepositories(basePackages = { "com.sunitkatkar.blogspot.tenant.repository",
		"com.sunitkatkar.blogspot.tenant.service" }, entityManagerFactoryRef = "tenantEntityManagerFactory", transactionManagerRef = "tenantTransactionManager")
public class TenantDatabaseConfig {
	...
	/*
	 * @Bean(name = "tenantTransactionManager") public JpaTransactionManager
	 * transactionManager( EntityManagerFactory tenantEntityManager) {
	 * JpaTransactionManager transactionManager = new JpaTransactionManager();
	 * transactionManager.setEntityManagerFactory(tenantEntityManager); return
	 * transactionManager; }
	 */
	 ...
	 * LocalContainerEntityManagerFactoryBean(); // All tenant related entities,
	 * repositories and service classes must be scanned
	 ...
	 * emfBean.setPersistenceUnitName("tenantdb-persistence-unit"); Map<String,
	 * Object> properties = new HashMap<>();
	 * properties.put(org.hibernate.cfg.Environment.MULTI_TENANT,
	 * MultiTenancyStrategy.SCHEMA); properties.put(org.hibernate.cfg.Environment.
	 * MULTI_TENANT_CONNECTION_PROVIDER, connectionProvider);
	 * properties.put(org.hibernate.cfg.Environment.
	 * MULTI_TENANT_IDENTIFIER_RESOLVER, tenantResolver); // ImprovedNamingStrategy
	 * is deprecated and unsupported in Hibernate 5 //
	 ...
	 * LOG.info("tenantEntityManagerFactory set up successfully!"); return emfBean;
	 * }
	 */
	/**
	 * Creates the entity manager factory bean which is required to access the JPA
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		// properties.put("hibernate.ejb.naming_strategy",
		// "org.hibernate.cfg.ImprovedNamingStrategy");
		properties.put(org.hibernate.cfg.Environment.DIALECT, "org.hibernate.dialect.PostgreSQL95Dialect");
		properties.put(org.hibernate.cfg.Environment.SHOW_SQL, true);
		properties.put(org.hibernate.cfg.Environment.FORMAT_SQL, true);
		properties.put(org.hibernate.cfg.Environment.HBM2DDL_AUTO, "update");
		properties.put(org.hibernate.cfg.Environment.NON_CONTEXTUAL_LOB_CREATION, true);
		properties.put(org.hibernate.cfg.Environment.HBM2DDL_JDBC_METADATA_EXTRACTOR_STRATEGY, "individually");		
